...
noTitleIndex: true
permalink: /programming/android/user-guide-v1.0.30.html
---
...
>- You can [get the source code of the HelloWord app here](https://github.com/Dynamsoft/document-normalizer-mobile-samples/tree/main/android/HelloWorld){:target="_blank"}.
