...
- Fixed a bug where license error is misreported when method [`getIntermediateResultManager`]({{ site.dcv_android_api }}capture-vision-router/intermediate-result.html#getintermediateresultmanager) is triggered.
